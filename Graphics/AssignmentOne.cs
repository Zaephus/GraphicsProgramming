...
public class AssignmentOne : Game {
    ...
    private GameObject testSphere = new GameObject(new MeshRenderer(Primitives.Sphere));
    ...
    private Material testMat = new Material("Core/Graphics/Shaders/Vertex.glsl", "Core/Graphics/Shaders/TestFragment.glsl");
    ...
    protected override void Start() {
        ...
        testSphere.GetComponent<MeshRenderer>().material = testMat;
